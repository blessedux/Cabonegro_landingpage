...
// Properly memoize NavbarZh - only re-render when pathname changes
// Since NavbarZh uses hooks internally, we can't prevent all re-renders,
// but we can prevent parent-triggered re-renders
export default memo(NavbarZh)
