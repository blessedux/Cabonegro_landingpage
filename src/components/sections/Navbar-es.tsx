...
// Properly memoize NavbarEs - only re-render when pathname changes
// Since NavbarEs uses hooks internally, we can't prevent all re-renders,
// but we can prevent parent-triggered re-renders
export default memo(NavbarEs)
