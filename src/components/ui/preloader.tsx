...
const QUOTE_LINES = [
  'Cabo Negro: Where industrial ambition meets',
  'strategic location and renewable energy',
  'creating Chile\'s most transformative',
  'investment gateway to the world.'
]
...
export default function Preloader({ onComplete, duration = 6, className = '' }: PreloaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Quote Section - Only show when fonts are loaded */}
      {fontsLoaded && (
