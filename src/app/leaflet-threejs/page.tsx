...
export default function LeafletThreeJSPage() {
  ...
  useEffect(() => {
    // Initialize map first, then Three.js after a short delay
    initLeafletMap();
  ...
  const initThreeJS = () => {
    ...
    // Position the Three.js canvas to replace the map
    ...
    // No need for map events since we have orbital controls
  ...
  // Camera is now controlled by OrbitControls, no need for manual updates
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="mt-1 text-sm text-green-700">
                <p>
                  This demo uses <strong>Leaflet</strong> with <strong>OpenStreetMap</strong> tiles (completely free) 
                  combined with <strong>Three.js</strong> for 3D overlays. Perfect for development and testing!
                </p>
                <p className="mt-2">
                  <strong>Features:</strong> Interactive map, 3D industrial park, animated wind turbines, 
                  real-time synchronization between map and 3D scene.
                </p>
              </div>
            </div>
          </div>
