      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-6xl space-y-16 px-6">
          <div className="grid gap-6 text-center md:grid-cols-2 md:gap-12 md:text-left">
            <h1 className="text-4xl md:text-5xl font-semibold text-gray-900 dark:text-white">About Us</h1>
            ...
            <div className="flex flex-col gap-6 md:flex-1">
              <motion.div whileHover={{ scale: 1.03 }} transition={{ type: 'spring', stiffness: 250, damping: 20 }} className="relative overflow-hidden rounded-xl bg-black text-white shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <Button variant="outline" className="mt-4 border-white text-black dark:text-white hover:bg-white hover:text-black">
                    Learn More
                  </Button>
                </div>
              </motion.div>
