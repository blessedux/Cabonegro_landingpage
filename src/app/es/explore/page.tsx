...
function ExploreContent() {
  ...
  useEffect(() => {
    console.log('Spanish explore - preloader state:', { hasSeenPreloader, isPreloaderVisible, preloaderFadeComplete })
    if (hasSeenPreloader) {
    ...
    const fallbackTimer = setTimeout(() => {
      console.log('Spanish explore - fallback timer triggered')
      setPreloaderFadeComplete(true)
    }, 8000)
